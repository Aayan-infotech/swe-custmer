    ...
    return Stack(
      ...
      children: [
        TextFormField(
          ...
          style:  TextStyle(color: textColor, fontWeight: FontWeight.w500, fontSize: 14, fontFamily:Constants.mFontFamily),
          textAlign: textAlign,
          maxLines: maxLines,
          minLines: minLines,
          readOnly: isReadOnly,
          ...
          decoration: InputDecoration(
            ...
            suffix: suffix,
            errorMaxLines: 4,
            labelStyle:  TextStyle(color:  borderColor!,fontWeight: FontWeight.w500,fontSize: 16,fontFamily: Constants.mFontFamily),
            hintStyle: TextStyle(color: onSurfaceVariant.withOpacity(0.7), fontWeight: FontWeight.w500, fontSize: 12, fontFamily: Constants.mFontFamily),
